            ...
            {form.cover_image_url && (
              <div className="mt-2 w-32 h-20 rounded-lg overflow-hidden border border-gray-200 dark:border-white/10 relative group bg-gray-100 dark:bg-white/5">
                ...
                <button
                  ...
                  className="absolute top-1 right-1 w-6 h-6 rounded-full bg-red-500 text-white flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity z-10"
                >
                  <X className="w-3 h-3" />
                </button>
              </div>
